  ...
  const handleGenerateTest = async (existing = null) => {
    ...
    try {
      ...
      const res = await fetch('/api/generate', {
        ...
        body: JSON.stringify({ 
            // Сервер ожидает параметр "prompt"
          ...
          <div className="max-w-7xl w-full">
            ...
            <div className="bg-blue-900 p-8 rounded-[3rem] mb-12 shadow-2xl flex flex-col md:flex-row items-center gap-6 border-4 border-blue-500/20 text-center">
                ...
                <div className="flex-1 text-left">
                    ...
                    <p className="text-blue-200 text-[10px] font-bold uppercase tracking-widest text-left">Используем прокси Vercel + Hugging Face. Ключ не нужен на клиенте.</p>
                </div>
            </div>
